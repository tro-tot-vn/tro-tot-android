...
public class SocketEvents {
    ...
    public static final String EMIT_ICE_STATE_CHANGE = "video:call:iceStateChange";
    public static final String EMIT_CONNECTION_STATS = "video:call:connectionStats";
    ...
    public static final String LISTEN_ROOM_LEFT = "video:call:roomLeft";
    public static final String LISTEN_PARTICIPANT_JOINED = "video:call:participantJoined";
    public static final String LISTEN_PARTICIPANT_LEFT = "video:call:participantLeft";
    ...
    public static final String LISTEN_ICE_STATE_CHANGED = "video:call:iceStateChanged";
    public static final String LISTEN_PEER_STATS = "video:call:peerStats";
    public static final String LISTEN_ERROR = "video:call:error";
